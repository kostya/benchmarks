...
class CFG
{
    ...
    int getNumNodes()
    {
        return to!int(basicBlockMap.length);
    }
}
...
class HavlakLoopFinder
{
    ...
    int DSF(BasicBlock currentNode, UnionFindNode[] nodes, int[BasicBlock] number,
